<template>
  <div class="banner-element">
    <div class="container">
      <!-- <img class="tf-image" src="/img/67412323_495283111250152_9004867031664689152_n.png" /> -->
      <h1>ThirdFloor</h1>
      <h2>solutions</h2>
      <p
        class="hamble-brag"
      ...
      <ContactUsBtn :bgColor="'#ecc94b'" txtColor="#22292f">How can we help you?</ContactUsBtn>
      <img class="bg-image" src="/undraw/custom/drawing.svg" />
    </div>
  </div>
</template>
<script>
...
//   z-index: -1;
//   opacity: 1;
//    background: url("/undraw/custom/drawing.svg");

// //   background: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)),
// //     url("/unsplash/glenn-carstens-peters-SL5d_8ywAAA-unsplash.jpg");
